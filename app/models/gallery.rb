class Gallery
  ...
  field :name
  field :slug
  field :width, :type => Integer, :default => 900
  field :height, :type => Integer, :default => 900
  field :thumbnail_width, :type => Integer, :default => 150
  field :thumbnail_height, :type => Integer, :default => 100
